...
{
       0,    68,    68,    87,   105,   115,   134,   156,   182,   210,
     224,   250,   264,   293,   307,   328,   351,   367,   381
};
#endif
...
{
  "$end", "error", "$undefined", "T_INTLITERAL", "T_BEGIN_", "T_END",
  "T_READ", "T_WRITE", "T_LPAREN", "T_RPAREN", "T_SEMICOLON", "T_COMMA",
  "T_ASSIGNOP", "T_PLUSOP", "T_MINUSOP", "T_SCANEOF", "T_ID", "$accept",
  "start", "program", "statement_list", "statement", "id_list",
  "expr_list", "expression", "primary", YY_NULLPTR
};
#endif
...
{
      -3,     2,    11,     4,     5,    18,    20,    -2,   -14,   -14,
     -14,    17,    -1,    -1,   -14,   -14,   -14,     1,   -14,    -1,
     -14,    16,    15,   -14,    10,    24,    19,     8,    26,    -1,
      -1,    -1,   -14,   -14,   -14,   -14,   -14,    15,   -14,   -14
};
...
{
       0,     0,     0,     0,     0,     0,     0,     0,     4,     1,
       2,     0,     0,     0,     3,     5,     9,     0,    18,     0,
      17,     0,    11,    13,     0,     0,     0,     0,     0,     0,
       0,     0,     6,     7,    10,    16,     8,    12,    14,    15
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -14,   -14,   -14,   -14,    30,   -14,   -14,   -13,     0
};
...
{
      24,     1,    18,    14,     4,     5,    27,    19,     4,     5,
      25,     9,    26,    11,     6,    20,    37,    35,     6,    10,
      32,    30,    31,    30,    31,    28,    12,    29,    30,    31,
      38,    39,    13,    16,    33,    34,    36,    15
};

static const yytype_uint8 yycheck[] =
{
      13,     4,     3,     5,     6,     7,    19,     8,     6,     7,
       9,     0,    11,     8,    16,    16,    29,     9,    16,    15,
      10,    13,    14,    13,    14,     9,     8,    11,    13,    14,
      30,    31,    12,    16,    10,    16,    10,     7
};
...
{
       0,     4,    18,    19,     6,     7,    16,    20,    21,     0,
      15,     8,     8,    12,     5,    21,    16,    22,     3,     8,
      16,    23,    24,    25,    24,     9,    11,    24,     9,    11,
      13,    14,    10,    10,    16,     9,    10,    24,    25,    25
};
...
#line 69 "parser.y" /* yacc.c:1646  */
    {
			...
			if (cst_only == 1) {
				...
				start->append_child((yyvsp[-1].nodeval));
				start->append_child(new Node(SymbolClass::SCANEOF));

				root_node = start;
			} else {
				root_node = (yyvsp[-1].nodeval);
			}
...
#line 88 "parser.y" /* yacc.c:1646  */
    {
			...
			if (cst_only == 1) {
				...
				program->append_child((yyvsp[-1].nodeval));
				program->append_child(new Node(SymbolClass::END));
			} else {
				program->append_child((yyvsp[-1].nodeval));
			}

			(yyval.nodeval) = program;
		}
...
#line 106 "parser.y" /* yacc.c:1646  */
    {
					...
					statement_list->append_child((yyvsp[0].nodeval));

					(yyval.nodeval) = statement_list;
				}
...
#line 116 "parser.y" /* yacc.c:1646  */
    {
					...
					if (cst_only == 1) {
						...
						statement_list->append_child((yyvsp[-1].nodeval));
						statement_list->append_child((yyvsp[0].nodeval));

						(yyval.nodeval) = statement_list;
					} else {
						(yyvsp[-1].nodeval)->append_child((yyvsp[0].nodeval));
...
#line 135 "parser.y" /* yacc.c:1646  */
    {
				...
				if (cst_only == 1) {
					...
					statement->append_child((yyvsp[-1].nodeval));
					statement->append_child(new Node(SymbolClass::SEMICOLON));

					(yyval.nodeval) = statement;
				} else {
					Node* assignop = new Node(SymbolClass::ASSIGNOP, (yyvsp[-2].strval));

					assignop->append_child(new Node(SymbolClass::ID, (yyvsp[-3].strval)));
					assignop->append_child((yyvsp[-1].nodeval));

					(yyval.nodeval) = assignop;
				}
		  	}
...
#line 157 "parser.y" /* yacc.c:1646  */
    {
				...
				if (cst_only == 1) {
					...
					statement->append_child((yyvsp[-2].nodeval));
					statement->append_child(new Node(SymbolClass::RPAREN));
					statement->append_child(new Node(SymbolClass::SEMICOLON));

					(yyval.nodeval) = statement;
				} else {
					Node* read = new Node(SymbolClass::READ, (yyvsp[-4].strval));

					if ((yyvsp[-2].nodeval)->children.size()) {
						read->children = (yyvsp[-2].nodeval)->children;
					} else {
						read->append_child((yyvsp[-2].nodeval));
					}
...
#line 183 "parser.y" /* yacc.c:1646  */
    {
				...
				if (cst_only == 1) {
					...
					Node* write = new Node(SymbolClass::WRITE, (yyvsp[-4].strval));

					if ((yyvsp[-2].nodeval)->children.size() && !(yyvsp[-2].nodeval)->should_preserver_in_ast()) {
						write->children = (yyvsp[-2].nodeval)->children;
					} else {
						write->append_child((yyvsp[-2].nodeval));
					}
...
#line 211 "parser.y" /* yacc.c:1646  */
    {
			...
			if (cst_only == 1) {
				...
				id_list->append_child(new Node(SymbolClass::ID, (yyvsp[0].strval)));
			}

			(yyval.nodeval) = id_list;
		}
...
#line 225 "parser.y" /* yacc.c:1646  */
    {
			...
			if (cst_only == 1) {
				...
				id_list->append_child((yyvsp[-2].nodeval));
			} else {
				if ((yyvsp[-2].nodeval)->children.size()) {
					id_list->children = (yyvsp[-2].nodeval)->children;
					id_list->append_child(new Node(SymbolClass::ID, (yyvsp[0].strval)));
				} else {
					Node* id_list = new Node(SymbolClass::ID_LIST);
...
#line 251 "parser.y" /* yacc.c:1646  */
    {
				...
				if (cst_only == 1) {
					...
					expr_list->append_child((yyvsp[0].nodeval));

					(yyval.nodeval) = expr_list;
				} else {
...
#line 265 "parser.y" /* yacc.c:1646  */
    {
				...
				if (cst_only == 1) {
					...
					expr_list->append_child((yyvsp[-2].nodeval));
					...
					if ((yyvsp[-2].nodeval)->children.size()) {
						(yyvsp[-2].nodeval)->append_child((yyvsp[0].nodeval));
...
#line 294 "parser.y" /* yacc.c:1646  */
    {
				...
				if (cst_only == 1) {
					...
					expression->append_child((yyvsp[0].nodeval));

					(yyval.nodeval) = expression;
				} else {
					(yyval.nodeval) = (yyvsp[0].nodeval);
				}
			}
...
#line 308 "parser.y" /* yacc.c:1646  */
    {
				...
				if (cst_only == 1) {
					...
					expression->append_child((yyvsp[-2].nodeval));
					expression->append_child(new Node(SymbolClass::PLUSOP));
					expression->append_child((yyvsp[0].nodeval));

					(yyval.nodeval) = expression;
				} else {
					Node* plusop = new Node(SymbolClass::PLUSOP, (yyvsp[-1].strval));

					plusop->append_child((yyvsp[-2].nodeval));
					plusop->append_child((yyvsp[0].nodeval));

					(yyval.nodeval) = plusop;
				}
		   	}
...
#line 329 "parser.y" /* yacc.c:1646  */
    {
				...
				if (cst_only == 1) {
					...
					Node* minusop = new Node(SymbolClass::MINUSOP, (yyvsp[-1].strval));

					minusop->append_child((yyvsp[-2].nodeval));
					minusop->append_child((yyvsp[0].nodeval));

					(yyval.nodeval) = minusop;
				}
			}
...
#line 352 "parser.y" /* yacc.c:1646  */
    {
			...
			if (cst_only == 1) {
				...
				primary->append_child((yyvsp[-1].nodeval));
				primary->append_child(new Node(SymbolClass::RPAREN));

				(yyval.nodeval) = primary;
			} else {
				(yyval.nodeval) = (yyvsp[-1].nodeval);
			}
		}
...
#line 368 "parser.y" /* yacc.c:1646  */
    {
			...
			if (cst_only == 1) {
				...
				(yyval.nodeval) = new Node(SymbolClass::ID, (yyvsp[0].strval));
			}
		}
...
#line 382 "parser.y" /* yacc.c:1646  */
    {
			...
			if (cst_only == 1) {
				...
				char intstr[11];
				sprintf(intstr, "%d", (yyvsp[0].intval));

				(yyval.nodeval) = new Node(SymbolClass::INTLITERAL, intstr);
			}
		}
